...
# 유튜브 다운로더 만들기
![image](https://user-images.githubusercontent.com/47412229/207483053-56b80bc5-aecc-49ff-a8fe-90693087e85a.png) 

[ytd.exe](https://github.com/kig2929kig/youtubeDownload/blob/main/ytd.exe)
...
def play() :
    ...
    while pygame.mixer.music.get_endevent() :
        print("종료")    
...
def file_list() :
    ...
    for file in file_lst :
        if file.endswith(".mp3") :
            index += 1
            f_list.insert(index, " {:03d} | {}".format(index, str(file)))
...
#################################################################################################################
#folder_list_frame
f_list = Listbox(folder_list_frame)
...
file_list()
#f_list.bind("<<ListboxSelect>>", f_list_select)
